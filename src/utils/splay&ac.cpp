...
#include <queue>
using namespace std;
const int MAX_NUM = 400;		  //��ͬ�ַ�����*2
const int TOT = 1e6 + 10;		  //ģ���ܳ�*2
const int MAX_MOBAN = 1e2;		  //�ģ�泤��*2
const int TOTOT_MOBAN = 1e6 + 10; //ģ������
const int TOT_TEXT = 1e8;		  //�ı����� *2
//ӳ���ַ�splay tree
int change(char c)
{ //�ַ�ת�����뺯��
	return c;
